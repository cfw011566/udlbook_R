...
knitr::opts_chunk$set(echo = TRUE, fig.width=8, fig.height=6, out.width="80%", fig.retina=2, fig.align="center")
...
draw_2D_function <- function(x1, x2, y) {
  filled.contour(x1, x2, y,
		 ...
		 plot.title = title(main = "Filled Contour Plot", xlab = "X-axis", ylab = "Y-axis"))
}
```

```{r}
# Define a linear function with two inputs, x1 and x2
linear_function_2D <- function(x1,x2,beta=0,omega1=1,omega2=-0.5) {
...
# y_func <- function(x, y) { linear_function_2D(x,y,beta,omega1,omega2) }
# y  <- outer(x1, x2, y_func)
y  <- outer(x1, x2, function(x, y) { linear_function_2D(x,y,beta, omega1, omega2)})

# Draw the function.
# draw_2D_function(x1, x2, y)
filled.contour(x1, x2, y, plot.title = title(xlab = "x1", ylab = "x2"))
...
# Plot this function
plot(x,y,type="l",xlim=c(-5,5),ylim=c(0,100),xlab="x",ylab="exp[x]",lwd=2,col="red")
```
...
# Plot this function
plot(x,y,type="l",xlim=c(0,5),ylim=c(-5,5),xlab="x",ylab="log[x]",lwd=2,col="red")
```
